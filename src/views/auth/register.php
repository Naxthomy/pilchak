...
<div class="text-center mb-4">
  ...
  <p class="auth-subtitle small">Sumate a la comunidad de Pilchak</p>
</div>

<form action="/src/controllers/auth/register.php" method="POST">
  <div class="mb-3">
    <label for="name" class="form-label">Usuario</label>
    <input type="text" class="form-control" id="name" name="name" placeholder="Tu usuario" required autofocus>
  </div>
...
<div class="text-center">
  <p class="auth-footer-text small">¿Ya tenés una cuenta? <a href="/src/views/auth/login.php">¡Inicia sesión!</a></p>
</div>